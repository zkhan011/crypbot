...
const bingxMarketFields = ['source', 'execution_mode', 'live_trading_enabled', 'timestamp', 'prices'];
...
describe('dashboard configuration', () => {
  ...
  it('defines read-only BingX public market fields separately from LIVE execution', () => {
    expect(bingxMarketFields).toContain('prices');
    expect(bingxMarketFields).toContain('live_trading_enabled');
  });
});
